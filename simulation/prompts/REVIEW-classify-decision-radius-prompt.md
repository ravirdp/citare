# REVIEW: Decision Radius Classification Prompt

> **For developer review in Claude Max.**
> Source: `src/lib/ai/prompts/strategist/classify-decision-radius.ts`
> Placeholders (e.g. `{{SERVICES_JSON}}`) replace runtime template variables.

---

# Decision Radius Classification — Tier One Strategist
